...
CREATE PROJECTION tpcds.date_dim_DBD_5_seg_DBD_TPCDS_INC2_b0 /*+basename(date_dim_DBD_5_seg_DBD_TPCDS_INC2),createtype(D)*/
(
 d_date_sk ENCODING COMMONDELTA_COMP, 
 d_date ENCODING COMMONDELTA_COMP
)
...
CREATE PROJECTION tpcds.date_dim_DBD_5_seg_DBD_TPCDS_INC2_b1 /*+basename(date_dim_DBD_5_seg_DBD_TPCDS_INC2),createtype(D)*/
(
 d_date_sk ENCODING COMMONDELTA_COMP, 
 d_date ENCODING COMMONDELTA_COMP
)
