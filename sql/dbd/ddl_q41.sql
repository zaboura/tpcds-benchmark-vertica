...
CREATE PROJECTION tpcds.item_DBD_1_seg_DBD_TPCDS_INC2_b0 /*+basename(item_DBD_1_seg_DBD_TPCDS_INC2),createtype(D)*/
(
...
CREATE PROJECTION tpcds.item_DBD_1_seg_DBD_TPCDS_INC2_b1 /*+basename(item_DBD_1_seg_DBD_TPCDS_INC2),createtype(D)*/
(
 i_category ENCODING ZSTD_FAST_COMP, 
 i_manufact_id ENCODING DELTAVAL, 
 i_manufact ENCODING ZSTD_FAST_COMP, 
