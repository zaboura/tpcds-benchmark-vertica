...
CREATE PROJECTION tpcds.date_dim_DBD_1_rep_DBD_TPCDS_INC2_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION tpcds.item_DBD_2_rep_DBD_TPCDS_INC2_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION tpcds.store_DBD_4_seg_DBD_TPCDS_INC2_b0 /*+basename(store_DBD_4_seg_DBD_TPCDS_INC2),createtype(D)*/
(
...
CREATE PROJECTION tpcds.store_DBD_4_seg_DBD_TPCDS_INC2_b1 /*+basename(store_DBD_4_seg_DBD_TPCDS_INC2),createtype(D)*/
(
 s_store_sk ENCODING COMMONDELTA_COMP, 
 s_store_id ENCODING ZSTD_FAST_COMP
)
