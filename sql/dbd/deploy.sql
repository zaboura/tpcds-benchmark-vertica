...
CREATE PROJECTION call_center_DBD_1_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION catalog_page_DBD_2_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION catalog_returns_DBD_3_seg_MC_TPCDS_COMP_v1_b0 /*+basename(catalog_returns_DBD_3_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
...
CREATE PROJECTION catalog_returns_DBD_3_seg_MC_TPCDS_COMP_v1_b1 /*+basename(catalog_returns_DBD_3_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
 cr_item_sk ENCODING DELTAVAL, 
 cr_order_number ENCODING DELTARANGE_COMP, 
 cr_returned_date_sk ENCODING DELTARANGE_COMP, 
...
CREATE PROJECTION catalog_sales_DBD_4_seg_MC_TPCDS_COMP_v1_b0 /*+basename(catalog_sales_DBD_4_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
...
CREATE PROJECTION catalog_sales_DBD_4_seg_MC_TPCDS_COMP_v1_b1 /*+basename(catalog_sales_DBD_4_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
 cs_item_sk ENCODING DELTAVAL, 
 cs_order_number ENCODING DELTAVAL, 
 cs_sold_date_sk ENCODING DELTAVAL, 
...
select refresh('tpcds.call_center, tpcds.catalog_page, tpcds.catalog_returns, tpcds.catalog_sales');

select make_ahm_now();

DROP PROJECTION tpcds.call_center_DBD_1_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.catalog_page_DBD_2_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.catalog_returns_DBD_3_seg_MC_TPCDS_COMP_b0, tpcds.catalog_returns_DBD_3_seg_MC_TPCDS_COMP_b1 CASCADE;

DROP PROJECTION tpcds.catalog_sales_DBD_4_seg_MC_TPCDS_COMP_b0, tpcds.catalog_sales_DBD_4_seg_MC_TPCDS_COMP_b1 CASCADE;

CREATE PROJECTION customer_address_DBD_5_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION customer_demographics_DBD_6_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION customer_DBD_7_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION date_dim_DBD_8_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
select refresh('tpcds.customer_address, tpcds.customer_demographics, tpcds.customer, tpcds.date_dim');

select make_ahm_now();

DROP PROJECTION tpcds.customer_address_DBD_5_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.customer_demographics_DBD_6_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.customer_DBD_7_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.date_dim_DBD_8_rep_MC_TPCDS_COMP CASCADE;

CREATE PROJECTION household_demographics_DBD_9_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION income_band_DBD_10_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION inventory_DBD_11_seg_MC_TPCDS_COMP_v1_b0 /*+basename(inventory_DBD_11_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
...
CREATE PROJECTION inventory_DBD_11_seg_MC_TPCDS_COMP_v1_b1 /*+basename(inventory_DBD_11_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
 inv_item_sk ENCODING DELTARANGE_COMP, 
 inv_date_sk ENCODING RLE, 
 inv_warehouse_sk ENCODING RLE, 
...
CREATE PROJECTION item_DBD_12_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
select refresh('tpcds.household_demographics, tpcds.income_band, tpcds.inventory, tpcds.item');

select make_ahm_now();

DROP PROJECTION tpcds.household_demographics_DBD_9_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.income_band_DBD_10_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.inventory_DBD_11_seg_MC_TPCDS_COMP_b0, tpcds.inventory_DBD_11_seg_MC_TPCDS_COMP_b1 CASCADE;

DROP PROJECTION tpcds.item_DBD_12_rep_MC_TPCDS_COMP CASCADE;

CREATE PROJECTION promotion_DBD_13_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION reason_DBD_14_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION ship_mode_DBD_15_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION store_returns_DBD_16_seg_MC_TPCDS_COMP_v1_b0 /*+basename(store_returns_DBD_16_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
...
CREATE PROJECTION store_returns_DBD_16_seg_MC_TPCDS_COMP_v1_b1 /*+basename(store_returns_DBD_16_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
 sr_item_sk ENCODING DELTAVAL, 
 sr_ticket_number ENCODING DELTARANGE_COMP, 
 sr_returned_date_sk ENCODING DELTAVAL, 
...
select refresh('tpcds.promotion, tpcds.reason, tpcds.ship_mode, tpcds.store_returns');

select make_ahm_now();

DROP PROJECTION tpcds.promotion_DBD_13_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.reason_DBD_14_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.ship_mode_DBD_15_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.store_returns_DBD_16_seg_MC_TPCDS_COMP_b0, tpcds.store_returns_DBD_16_seg_MC_TPCDS_COMP_b1 CASCADE;

CREATE PROJECTION store_sales_DBD_17_seg_MC_TPCDS_COMP_v1_b0 /*+basename(store_sales_DBD_17_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
...
CREATE PROJECTION store_sales_DBD_17_seg_MC_TPCDS_COMP_v1_b1 /*+basename(store_sales_DBD_17_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
 ss_item_sk ENCODING DELTAVAL, 
 ss_ticket_number ENCODING DELTARANGE_COMP, 
 ss_sold_date_sk ENCODING DELTAVAL, 
...
CREATE PROJECTION store_DBD_18_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION time_dim_DBD_19_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION warehouse_DBD_20_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
select refresh('tpcds.store_sales, tpcds.store, tpcds.time_dim, tpcds.warehouse');

select make_ahm_now();

DROP PROJECTION tpcds.store_sales_DBD_17_seg_MC_TPCDS_COMP_b0, tpcds.store_sales_DBD_17_seg_MC_TPCDS_COMP_b1 CASCADE;

DROP PROJECTION tpcds.store_DBD_18_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.time_dim_DBD_19_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.warehouse_DBD_20_rep_MC_TPCDS_COMP CASCADE;

CREATE PROJECTION web_page_DBD_21_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
CREATE PROJECTION web_returns_DBD_22_seg_MC_TPCDS_COMP_v1_b0 /*+basename(web_returns_DBD_22_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
...
CREATE PROJECTION web_returns_DBD_22_seg_MC_TPCDS_COMP_v1_b1 /*+basename(web_returns_DBD_22_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
 wr_item_sk ENCODING DELTAVAL, 
 wr_order_number ENCODING DELTARANGE_COMP, 
 wr_returned_date_sk ENCODING DELTAVAL, 
...
CREATE PROJECTION web_sales_DBD_23_seg_MC_TPCDS_COMP_v1_b0 /*+basename(web_sales_DBD_23_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
...
CREATE PROJECTION web_sales_DBD_23_seg_MC_TPCDS_COMP_v1_b1 /*+basename(web_sales_DBD_23_seg_MC_TPCDS_COMP_v1),createtype(D)*/
(
 ws_item_sk ENCODING DELTAVAL, 
 ws_order_number ENCODING DELTAVAL, 
 ws_sold_date_sk ENCODING DELTAVAL, 
...
CREATE PROJECTION web_site_DBD_24_rep_MC_TPCDS_COMP_v1 /*+createtype(D)*/
(
...
select refresh('tpcds.web_page, tpcds.web_returns, tpcds.web_sales, tpcds.web_site');

select make_ahm_now();

DROP PROJECTION tpcds.web_page_DBD_21_rep_MC_TPCDS_COMP CASCADE;

DROP PROJECTION tpcds.web_returns_DBD_22_seg_MC_TPCDS_COMP_b0, tpcds.web_returns_DBD_22_seg_MC_TPCDS_COMP_b1 CASCADE;

DROP PROJECTION tpcds.web_sales_DBD_23_seg_MC_TPCDS_COMP_b0, tpcds.web_sales_DBD_23_seg_MC_TPCDS_COMP_b1 CASCADE;

DROP PROJECTION tpcds.web_site_DBD_24_rep_MC_TPCDS_COMP CASCADE;