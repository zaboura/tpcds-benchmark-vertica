...
CREATE PROJECTION tpcds.date_dim_DBD_1_rep_DBD_TPCDS_INC2_v3 /*+createtype(D)*/
(
...
CREATE PROJECTION tpcds.store_sales_DBD_2_seg_DBD_TPCDS_INC2_v3_b0 /*+basename(store_sales_DBD_2_seg_DBD_TPCDS_INC2_v3),createtype(D)*/
(
...
CREATE PROJECTION tpcds.store_sales_DBD_2_seg_DBD_TPCDS_INC2_v3_b1 /*+basename(store_sales_DBD_2_seg_DBD_TPCDS_INC2_v3),createtype(D)*/
(
 ss_item_sk ENCODING DELTAVAL, 
 ss_sold_date_sk ENCODING RLE, 
 ss_store_sk ENCODING RLE, 
...
CREATE PROJECTION tpcds.store_DBD_4_seg_DBD_TPCDS_INC2_v1_b0 /*+basename(store_DBD_4_seg_DBD_TPCDS_INC2_v1),createtype(D)*/
(
...
CREATE PROJECTION tpcds.store_DBD_4_seg_DBD_TPCDS_INC2_v1_b1 /*+basename(store_DBD_4_seg_DBD_TPCDS_INC2_v1),createtype(D)*/
(
 s_store_sk ENCODING COMMONDELTA_COMP, 
 s_store_id ENCODING ZSTD_FAST_COMP
)
