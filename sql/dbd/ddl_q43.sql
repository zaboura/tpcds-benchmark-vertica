...
CREATE PROJECTION tpcds.date_dim_DBD_1_rep_DBD_TPCDS_INC2 /*+createtype(D)*/
(
...
CREATE PROJECTION tpcds.store_sales_DBD_2_seg_DBD_TPCDS_INC2_b0 /*+basename(store_sales_DBD_2_seg_DBD_TPCDS_INC2),createtype(D)*/
(
...
CREATE PROJECTION tpcds.store_sales_DBD_2_seg_DBD_TPCDS_INC2_b1 /*+basename(store_sales_DBD_2_seg_DBD_TPCDS_INC2),createtype(D)*/
(
 ss_sold_date_sk ENCODING RLE, 
 ss_store_sk ENCODING RLE, 
 ss_sales_price ENCODING DELTARANGE_COMP
