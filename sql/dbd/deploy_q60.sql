...
CREATE PROJECTION customer_address_DBD_1_rep_DBD_TPCDS_INC2_v2 /*+createtype(D)*/
(
...
CREATE PROJECTION store_sales_DBD_2_seg_DBD_TPCDS_INC2_v2_b0 /*+basename(store_sales_DBD_2_seg_DBD_TPCDS_INC2_v2),createtype(D)*/
(
...
CREATE PROJECTION store_sales_DBD_2_seg_DBD_TPCDS_INC2_v2_b1 /*+basename(store_sales_DBD_2_seg_DBD_TPCDS_INC2_v2),createtype(D)*/
(
 ss_item_sk ENCODING DELTARANGE_COMP, 
 ss_sold_date_sk ENCODING DELTAVAL, 
 ss_addr_sk ENCODING RLE, 
